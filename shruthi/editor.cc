...
const prog_uint8_t oscillator_shape_map[] PROGMEM = {
  ...
  WAVEFORM_TRIANGLE,
  WAVEFORM_CZ_SAW,
  WAVEFORM_CZ_RESO_SAW_LP,
  WAVEFORM_CZ_RESO_SAW_PK,
  WAVEFORM_CZ_RESO_SAW_HP,
  WAVEFORM_CZ_RESO_PLS_LP,
  WAVEFORM_CZ_RESO_PLS_PK,
  WAVEFORM_CZ_RESO_PLS_HP,
  WAVEFORM_CZ_RESO_SYNC,
  WAVEFORM_CZ_RESO_TRI,
